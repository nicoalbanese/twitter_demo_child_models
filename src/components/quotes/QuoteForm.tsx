...
import { type TAddOptimistic } from "@/app/quotes/useOptimisticQuotes";
...
const QuoteForm = ({
  ...
  const onSuccess = (
    ...
    toast({
      ...
      description: failed ? data?.error ?? "Error" : `Quote ${action}d!`,
  ...
  const handleSubmit = async (data: FormData) => {
    ...
    const quoteParsed = await insertQuoteParams.safeParseAsync({ bookId, ...payload });
