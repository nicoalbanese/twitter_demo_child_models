...
import { type Reflection, CompleteReflection } from "@/lib/db/schema/reflections";
import Modal from "@/components/shared/Modal";
import { type Book, type BookId } from "@/lib/db/schema/books";
import { useOptimisticReflections } from "@/app/reflections/useOptimisticReflections";
    ...
    <div className="text-center">
      ...
      <div className="mt-6">
        <Button onClick={() => openModal()}>
          <PlusIcon className="h-4" /> New Reflections </Button>
      </div>
    </div>
  );
};
